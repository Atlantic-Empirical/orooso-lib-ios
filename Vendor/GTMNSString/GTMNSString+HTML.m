...
- (NSString *)gtm_stringByStrippingHTML
{
    NSRange r;
    ...
    return [[s gtm_stringByUnescapingFromHTML] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
}
